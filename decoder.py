...
def txt_to_midi(filename):
    ...
    note_stream.write('midi', fp="data/midi_output/"+filename[12:-4]+".mid")
    print("Done! Decoded midi file saved to '/data/midi_output/'")

    
#if __name__ == "__main__":
#    parser = argparse.ArgumentParser()
#    parser.add_argument("filename", type=str, help="Copy file into the folder 'txt-files/notewise/custom/'.")
